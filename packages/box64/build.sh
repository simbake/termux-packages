...
TERMUX_PKG_DEPENDS="libandroid-sysv-semaphore, libandroid-spawn, libandroid-spawn-static, lib32-libandroid-support, libandroid-execinfo, libandroid-glob, libandroid-support"
