...
TERMUX_PKG_DEPENDS="libandroid-sysv-semaphore, libandroid-spawn, libandroid-spawn-static, libandroid-execinfo, libandroid-glob, libandroid-support, libandroid-posix-semaphore, libfixposix"
