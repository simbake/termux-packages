...
TERMUX_PKG_DEPENDS="libandroid-shmem, libc++, libllvm (<< ${_LLVM_MAJOR_VERSION_NEXT}), libxext, libxfixes, libxshmfence, libxxf86vm, ncurses, vulkan-loader-android, zlib, zstd, libwayland, libdrm, libepoxy, libglvnd, libx11, mesa"
